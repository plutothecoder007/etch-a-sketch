...
2. Put divs into a "container" div.
3. Use flexbox to make divs appear as a grid.
4. Set up a "hover" effect so that grid divs change colour when mouse passes over them, leaving a pixelated trail through the grid like a pen would.
